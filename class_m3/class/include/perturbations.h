...
struct perturbs
{
 ...
 int size_tensor_perturbation_data[_MAX_NUMBER_OF_K_FILES_]; /**< Array of sizes of tensor double pointers  */
  ...
  short has_source_delta_sfdm_3;  /**< do we need source for delta from scalar field dark matter? */
  ...
  /*Scalar Field Dark Matter 3*/
  short has_source_theta_sfdm_3;  /**< do we need source for theta of scalar field dark matter? */
  ...
  /*Scalar Field Dark Matter 3*/
  int index_tp_delta_sfdm_3;  /**< index value for delta of scalar field dark matter */
  ...
  /*Scalar Field Dark Matter 3*/
  int index_tp_theta_sfdm_3;  /**< index value for theta of scalar field dark matter */
...
struct perturb_vector
{
  ...
  /*Scalar Field Dark Matter 3*/
  int index_pt_delta_sfdm_3;  /**< scalar field dark matter density contrast */
  int index_pt_delta1_sfdm_3;  /**< scalar field dark matter auxiliary density contrast */
  int index_pt_omega_sfdm_3;  /**< scalar field dark matter frequency */
