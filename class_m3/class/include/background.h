...
struct background
{
  ...
  double Omega0_sfdm_3;        /**< \f$ \Omega_{0 sfdm} \f$: scalar field dark matter */
  //int expo_sfdm_3;             /**< \f$ \expo_{0 sfdm} \f$: scalar field dark matter power potential*/
  short attractor_ic_sfdm_3;   /**< whether the scalar field dark matter has attractor initial conditions */
  double theta_ini_sfdm_3;       /**< \f$ \theta_sfdm(t_0) \f$: scalar field initial angular value */
  double y1_ini_sfdm_3;       /**< \f$ y1_sfdm(t_0) \f$: scalar field initial potential value */
  double alpha_ini_sfdm_3;       /**< \f$ alpha_sfdm(t_0) \f$: scalar field initial 0.5*log(Omega_ini) value */
  double Omega_ini_sfdm_3; /**< \f$ Omega_sfdm(t_0) \f$: scalar field initial density parameter */
  double * sfdm_parameters_3;  /**< list of parameters describing the scalar field dark matter potential */
  int sfdm_parameters_size_3;  /**< size of sfdm_parameters */
  int sfdm_tuning_index_3;     /**< index in sfdm_parameters used for tuning */
  ...
  /*Scalar field dark matter 3*/
  int index_bg_theta_sfdm_3;       /**< scalar field dark matter angular variable */
  int index_bg_y1_sfdm_3; /**< scalar field dark matter potential variable */
  int index_bg_y2_sfdm_3; /*SFDM y2 auxiliar variable*/
  int index_bg_alpha_sfdm_3;         /**< scalar field dark matter 0.5*log(density parameter) */
  int index_bg_rho_sfdm_3;       /**< scalar field dark matter energy density */
  int index_bg_p_sfdm_3;         /**< scalar field dark matter pressure */
  ...
  int index_bg_w_tot_3;         /**< total equation of state */
  ...
  /*Scalar field dark matter 3*/
  int index_bi_theta_sfdm_3;       /**< {B} scalar field dark matter angular variable */
  int index_bi_y1_sfdm_3;       /**< {B} scalar field dark matter potential variable */
  int index_bi_alpha_sfdm_3; /**< {B} scalar field dark matter 0.5*log(density parameter) */
  ...
  short has_sfdm_3;       /**< presence of scalar field dark matter 3? */
