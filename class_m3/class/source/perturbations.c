...
int perturb_indices_of_perturbs(
  ...
  /*Scalar Field Dark Matter 3*/
  ppt->has_source_delta_sfdm_3 = _FALSE_;
  ...
  /*Scalar Field Dark Matter 3*/
  ppt->has_source_theta_sfdm_3 = _FALSE_;
  ...
  for (index_md = 0; index_md < ppt->md_size; index_md++) {
    ...
    if (_scalars_) {
      ...
      if (ppt->has_density_transfers == _TRUE_) {
        ...
        /*Scalar Field Dark Matter 3*/
        if (pba->has_sfdm_3 == _TRUE_)
          ppt->has_source_delta_sfdm_3 = _TRUE_;
      ...
      if (ppt->has_velocity_transfers == _TRUE_) {
        ...
        /*Scalar Field Dark Matter 3*/
        if (pba->has_sfdm_3 == _TRUE_)
          ppt->has_source_theta_sfdm_3 = _TRUE_;
        if (pba->has_scf == _TRUE_)
      ...
      /*Scalar Field Dark Matter 3*/
      class_define_index(ppt->index_tp_delta_sfdm_3,  ppt->has_source_delta_sfdm_3, index_type,1);
      ...
      /*Scalar Field Dark Matter 3*/
      class_define_index(ppt->index_tp_theta_sfdm_3,  ppt->has_source_theta_sfdm_3, index_type,1);
...
int perturb_solve(
  ...
  /* Related to sfdm 3*/
  double alpha_sfdm_3, theta_sfdm_3, y1_sfdm_3, m_sfdm_over_H_3;
  ...
  while ((tau_upper - tau_lower)/tau_lower > ppr->tol_tau_approx) {
    ...
    /*Scalar Field Dark Matter 3*/
    if (pba->has_sfdm_3 == _TRUE_) {
      alpha_sfdm_3 = ppw->pvecback[pba->index_bg_alpha_sfdm_3];
      theta_sfdm_3 = ppw-> pvecback[pba->index_bg_theta_sfdm_3];
      y1_sfdm_3 = ppw->pvecback[pba->index_bg_y1_sfdm_3];
      if(pba->sfdm_parameters_3[1] >= 0.){
        m_sfdm_over_H_3 = 0.5*pow(pow(y1_sfdm_3,2.)+2.*pba->sfdm_parameters_3[1]*exp(alpha_sfdm_3)*
                                  cos_sfdm(pba,0.5*theta_sfdm_3)*cos_sfdm(pba,0.5*theta_sfdm_3),0.5);
      }
      if(pba->sfdm_parameters_3[1] < 0.){
        m_sfdm_over_H_3 = 0.5*exp(ppw->pvecback[pba->index_bg_y1_sfdm_3]);
      }
      if (m_sfdm_over_H_3 > 1.e-2)
        is_early_enough = _FALSE_;
    }
...
int perturb_prepare_output(struct background * pba,
  ...
  if (ppt->k_output_values_num > 0) {
    ...
    if (ppt->has_scalars == _TRUE_){
      ...
      /* Scalar Field Dark Matter sfdm 3*/
      class_store_columntitle(ppt->scalar_titles, "delta_sfdm_3", pba->has_sfdm_3);
      class_store_columntitle(ppt->scalar_titles, "theta_sfdm_3", pba->has_sfdm_3);
      class_store_columntitle(ppt->scalar_titles, "omega_sfdm_3", pba->has_sfdm_3);
      //class_store_columntitle(ppt->scalar_titles, "fk_sfdm_3", pba->has_sfdm_3);//Como no necesita ser integrada no se define
      /* Scalar field scf */
...
int perturb_vector_init(
  ...
  if (_scalars_) {
    ...
    /* Scalar Field Fark Matter 3*/
    class_define_index(ppv->index_pt_omega_sfdm_3, pba->has_sfdm_3,index_pt,1);/*sfdm_3 frequency*/
    class_define_index(ppv->index_pt_delta_sfdm_3,pba->has_sfdm_3,index_pt,1); /* scalar field dark matter denstiy constrast */
    class_define_index(ppv->index_pt_delta1_sfdm_3,pba->has_sfdm_3,index_pt,1); /* scalar field dark matter auxiliary contrast. See arXiv: 1511.08195*/
  ...
  /** - case of switching approximation while a wavenumber is being integrated */
    ...
    if (_scalars_) {
      ...
      if (pba->has_sfdm_3 == _TRUE_) {
        ...
        ppv->y[ppv->index_pt_omega_sfdm_3] =
        ppw->pv->y[ppw->pv->index_pt_omega_sfdm_3];
        
        ppv->y[ppv->index_pt_delta_sfdm_3] =
        ppw->pv->y[ppw->pv->index_pt_delta_sfdm_3];
        
        ppv->y[ppv->index_pt_delta1_sfdm_3] =
        ppw->pv->y[ppw->pv->index_pt_delta1_sfdm_3];
      }
...
int perturb_initial_conditions(struct precision * ppr,
  ...
  /*Scalar Field Dark Matter 3*/
  double delta_sfdm_3=0.,theta_sfdm_3=0.;
  double q,epsilon,k2;
  int index_q,n_ncdm,idx;
  double rho_r,rho_m,rho_nu,rho_m_over_rho_r;
  double fracnu,fracg,fracb,fraccdm,fracsfdm_1, fracsfdm_2,fracsfdm_3,om;
  ...
  if (_scalars_) {
    ...
    if (pba->has_sfdm_3 == _TRUE_) {
      if (pba->sfdm_parameters_3[1] < 0.){
        rho_r += ppw->pvecback[pba->index_bg_rho_sfdm_3];
      }
      if(pba->sfdm_parameters_3[1] >= 0.){
        rho_m += ppw->pvecback[pba->index_bg_rho_sfdm_3];
      }
    }
    ...
    */
    ...
    /*Scalar Field Dark Matter 3*/
    fracsfdm_3 = ppw->pvecback[pba->index_bg_rho_sfdm_3]/rho_m;

    /* f_cdm = Omega_cdm(t_i) / Omega_m(t_i) */
    // Notice that now it takes into account the presence of SFDM
    fraccdm = 1.-fracb-fracsfdm_1-fracsfdm_2-fracsfdm_3;
    ...
    */
    ...
    if ((ppt->has_ad == _TRUE_) && (index_ic == ppt->index_ic_ad)) {
      ...
      if (pba->has_sfdm_3 == _TRUE_) {
         ...
         *  initial perturbations set to the attractor solution, see arXiv:1511.08195, arXiv:1703.10180. */
        if (pba->sfdm_parameters_3[1] >= 0.){
          ppw->pv->y[ppw->pv->index_pt_omega_sfdm_3] = k*k/(pow(a*ppw->pvecback[pba->index_bg_H],2.)*ppw->pvecback[pba->index_bg_y1_sfdm_3]);
        }
        if(pba->sfdm_parameters_3[1] < 0.){
          ppw->pv->y[ppw->pv->index_pt_omega_sfdm_3] = k*k/(pow(a*ppw->pvecback[pba->index_bg_H],2.)*
                                                            exp(ppw->pvecback[pba->index_bg_y1_sfdm_3])*
                                                            pow(1.-pba->sfdm_parameters_3[1]*exp(ppw->pvecback[pba->index_bg_alpha_sfdm_3])*(1.+cos_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3]))/exp(2.*ppw->pvecback[pba->index_bg_y1_sfdm_3]),0.5));
        }
        ppw->pv->y[ppw->pv->index_pt_delta_sfdm_3] = (3./7.)*ppw->pv->y[ppw->pv->index_pt_delta_g]*sin(0.5*ppw->pvecback[pba->index_bg_theta_sfdm_3])*
        sin(ppw->pvecback[pba->index_bg_theta_sfdm_3]/12.);
        ppw->pv->y[ppw->pv->index_pt_delta1_sfdm_3] = (3./7.)*ppw->pv->y[ppw->pv->index_pt_delta_g]*sin(0.5*ppw->pvecback[pba->index_bg_theta_sfdm_3])*
        cos(ppw->pvecback[pba->index_bg_theta_sfdm_3]/12.);
      }
    ...
    if (ppt->gauge == newtonian) {
      ...
      */
      ...
      /*Scalar Field Dark Matter 3*/
      if (pba->has_sfdm_3 == _TRUE_) {
        delta_sfdm_3 = ppw->pv->y[ppw->pv->index_pt_delta_sfdm_3];
        // TODO: Include the right value of theta_sfdm here.
        theta_sfdm_3 = 0.;
      }
      ...
      delta_tot = (fracg*ppw->pv->y[ppw->pv->index_pt_delta_g]+fracnu*delta_ur+rho_m_over_rho_r*(fracb*ppw->pv->y[ppw->pv->index_pt_delta_b]+fraccdm*delta_cdm+fracsfdm_1*delta_sfdm_1+fracsfdm_2*delta_sfdm_2+fracsfdm_3*delta_sfdm_3))/(1.+rho_m_over_rho_r);

      velocity_tot = ((4./3.)*(fracg*ppw->pv->y[ppw->pv->index_pt_theta_g]+fracnu*theta_ur) + rho_m_over_rho_r*(fracb*ppw->pv->y[ppw->pv->index_pt_theta_b]+fracsfdm_1*theta_sfdm_1+fracsfdm_2*theta_sfdm_2+fracsfdm_3*theta_sfdm_3))/(1.+rho_m_over_rho_r);
      ...
      /*Scalar Field Dark Matter 3*/
      if (pba->has_sfdm_3 == _TRUE_) {
        ppw->pv->y[ppw->pv->index_pt_delta_sfdm_3] -= 3.*a_prime_over_a*alpha*(1.-cos_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3]));
        //ppw->pv->y[ppw->pv->index_pt_theta_sfdm] += k*k*alpha;
      }
...
int perturb_total_stress_energy(
  ...
  /*Scalar Field Dark Matter 3*/
  double delta_rho_sfdm_3, delta_p_sfdm_3, rho_plus_p_theta_sfdm_3;
  ...
  if (_scalars_) {
    ...
    /*Scalar Field Dark Matter 3. See arXiv: 1511.08195*/
    if (pba->has_sfdm_3 == _TRUE_) {
      
      //if (ppt->gauge == synchronous){
      delta_rho_sfdm_3 = ppw->pvecback[pba->index_bg_rho_sfdm_3]*y[ppw->pv->index_pt_delta_sfdm_3];
      delta_p_sfdm_3 = ppw->pvecback[pba->index_bg_rho_sfdm_3]*(y[ppw->pv->index_pt_delta1_sfdm_3]*sin_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])
                                                                -y[ppw->pv->index_pt_delta_sfdm_3]*cos_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3]));
      if (pba->sfdm_parameters_3[1] >= 0.){
        rho_plus_p_theta_sfdm_3 = k*k*ppw->pvecback[pba->index_bg_rho_sfdm_3]*(-y[ppw->pv->index_pt_delta_sfdm_3]*sin_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])+
                                                                               y[ppw->pv->index_pt_delta1_sfdm_3]*(1.-cos_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])))/
        (a*ppw->pvecback[pba->index_bg_H]*ppw->pvecback[pba->index_bg_y1_sfdm_3]);
      }
      if(pba->sfdm_parameters_3[1] < 0.){
        rho_plus_p_theta_sfdm_3 = k*k*ppw->pvecback[pba->index_bg_rho_sfdm_3]*(-y[ppw->pv->index_pt_delta_sfdm_3]*sin_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])+
                                                                               y[ppw->pv->index_pt_delta1_sfdm_3]*(1.-cos_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])))/
        (a*ppw->pvecback[pba->index_bg_H]*exp(ppw->pvecback[pba->index_bg_y1_sfdm_3])*pow(1.-pba->sfdm_parameters_3[1]*exp(ppw->pvecback[pba->index_bg_alpha_sfdm_3])*
                                                                                          (1. + cos_sfdm(pba, ppw->pvecback[pba->index_bg_theta_sfdm_3]))/exp(2.*ppw->pvecback[pba->index_bg_y1_sfdm_3]),0.5));
      }
      //else{
      /* Unverified! */
      //delta_rho_sfdm = ppw->pvecback[pba->index_bg_rho_sfdm]*y[ppw->pv->index_pt_delta_sfdm];
      ...
      ppw->delta_rho += delta_rho_sfdm_3;
      
      ppw->rho_plus_p_theta += rho_plus_p_theta_sfdm_3;
      
      ppw->delta_p += delta_p_sfdm_3;
      
      rho_plus_p_tot += ppw->pvecback[pba->index_bg_rho_sfdm_3]+ppw->pvecback[pba->index_bg_p_sfdm_3];
    ...
    */
    ...
    if ((ppt->has_source_delta_m == _TRUE_) || (ppt->has_source_theta_m == _TRUE_)) {
     ...
     /*Scalar Field Dark Matter 3*/
     if (pba->has_sfdm_3 == _TRUE_) {
        rho_plus_p_theta_m += rho_plus_p_theta_sfdm_3;
        rho_plus_p_m += ppw->pvecback[pba->index_bg_rho_sfdm_3]+ppw->pvecback[pba->index_bg_p_sfdm_3];
     }
...
int perturb_sources(
  ...
  /*Scalar Field Dark Matter 3*/
  double rho_plus_p_theta_sfdm_3;
  ...
  if (_scalars_) {
    ...
    if (ppt->has_source_delta_fld == _TRUE_) {
      ...
      /*Scalar Field Dark Matter 3*/
      if (ppt->has_source_delta_sfdm_3 == _TRUE_) {
          //if (ppt->gauge == synchronous){
          //    delta_rho_sfdm = pvecback[pba->index_bg_rho_sfdm]*y[ppw->pv->index_pt_delta_sfdm]);
          //}
          //else{
          //    delta_rho_sfdm = pvecback[pba->index_bg_rho_sfdm]*y[ppw->pv->index_pt_delta_sfdm];
          //}
        _set_source_(ppt->index_tp_delta_sfdm_3) = y[ppw->pv->index_pt_delta_sfdm_3];
      }
    ...
    /*Scalar Field Dark Matter 3*/
    if (ppt->has_source_theta_sfdm_3 == _TRUE_) {
      if (pba->sfdm_parameters_3[1] >= 0.){
        rho_plus_p_theta_sfdm_3 = k*k*ppw->pvecback[pba->index_bg_rho_sfdm_3]*(-y[ppw->pv->index_pt_delta_sfdm_3]*sin_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])+
                                                                               y[ppw->pv->index_pt_delta1_sfdm_3]*(1.-cos_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])))/
        (a_rel*ppw->pvecback[pba->index_bg_H]*ppw->pvecback[pba->index_bg_y1_sfdm_3]);
      }
      if(pba->sfdm_parameters_3[1] < 0.){
        rho_plus_p_theta_sfdm_3 = k*k*ppw->pvecback[pba->index_bg_rho_sfdm_3]*(-y[ppw->pv->index_pt_delta_sfdm_3]*sin_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])+
                                                                               y[ppw->pv->index_pt_delta1_sfdm_3]*(1.-cos_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])))/
        (a_rel*ppw->pvecback[pba->index_bg_H]*exp(ppw->pvecback[pba->index_bg_y1_sfdm_3]));
      }
      
      _set_source_(ppt->index_tp_theta_sfdm_3) = rho_plus_p_theta_sfdm_3/(pvecback[pba->index_bg_rho_sfdm_3]+pvecback[pba->index_bg_p_sfdm_3]);
    }
...
int perturb_print_variables(double tau,
  ...
  double delta_sfdm_2=0., theta_sfdm_2=0.;
  /*Scalar Field Dark Matter 3*/
  double delta_rho_sfdm_3=0., rho_plus_p_theta_sfdm_3=0., omega_sfdm_3=0.;
  double delta_sfdm_3=0., theta_sfdm_3=0.;
  ...
  if (_scalars_) {
    ...
    /*Scalar Field Dark Matter 3*/
    if (pba->has_sfdm_3 == _TRUE_){
      omega_sfdm_3 = y[ppw->pv->index_pt_omega_sfdm_3];
      delta_sfdm_3 = y[ppw->pv->index_pt_delta_sfdm_3];
      rho_plus_p_theta_sfdm_3 = k*k*ppw->pvecback[pba->index_bg_rho_sfdm_3]*(-y[ppw->pv->index_pt_delta_sfdm_3]*sin_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])+
                                                                             y[ppw->pv->index_pt_delta1_sfdm_3]*(1.-cos_sfdm(pba,ppw->pvecback[pba->index_bg_theta_sfdm_3])))/
      (a*ppw->pvecback[pba->index_bg_H]*ppw->pvecback[pba->index_bg_y1_sfdm_3]);
      theta_sfdm_3 = rho_plus_p_theta_sfdm_3/(pvecback[pba->index_bg_rho_sfdm_3]+pvecback[pba->index_bg_p_sfdm_3]);
    }
    ...
    if (ppt->gauge == synchronous) {
      ...
      if (pba->has_sfdm_3 == _TRUE_) {
        /** TODO: verification of the gauge transformation */
        delta_sfdm_3 -= 3.0*pvecback[pba->index_bg_H]*pvecback[pba->index_bg_a]*alpha*(1.0-cos_sfdm(pba,pvecback[pba->index_bg_theta_sfdm_3]));
        theta_sfdm_3 += k*k*alpha;
      }
    ...
    /* Scalar field dark matter 3 sfdm */
    class_store_double(dataptr, delta_sfdm_3, pba->has_sfdm_3, storeidx);
    class_store_double(dataptr, theta_sfdm_3, pba->has_sfdm_3, storeidx);
    class_store_double(dataptr, omega_sfdm_3, pba->has_sfdm_3, storeidx);
    /* Scalar field scf*/
...
int perturb_derivs(double tau,
  ...
  /* for use with scalar field dark matter 3 */
  double alpha_sfdm_3,theta_sfdm_3, y1_sfdm_3, omega_sfdm_3, delta_sfdm_3, delta1_sfdm_3;
  ...
  if (_scalars_) {
    ...
    /*Scalar Field Dark Matter 3*/
    if (pba->has_sfdm_3 == _TRUE_) {
      alpha_sfdm_3 = pvecback[pba->index_bg_alpha_sfdm_3];
      theta_sfdm_3 = pvecback[pba->index_bg_theta_sfdm_3];
      y1_sfdm_3 = pvecback[pba->index_bg_y1_sfdm_3];
      omega_sfdm_3 = y[pv->index_pt_omega_sfdm_3];
      delta_sfdm_3 = y[pv->index_pt_delta_sfdm_3];
      delta1_sfdm_3 = y[pv->index_pt_delta1_sfdm_3];
      /*Equations of motion*/
      if (pba->sfdm_parameters_3[1] >= 0.){
        /*omega*/
        dy[pv->index_pt_omega_sfdm_3] = a_prime_over_a*omega_sfdm_3*(1.5*pvecback[pba->index_bg_w_tot_3] - 0.5
                                                                     -y2_sfdm(pba, alpha_sfdm_3, theta_sfdm_3, y1_sfdm_3, pba->sfdm_parameters_3[1])*
                                                                     exp(0.5*alpha_sfdm_3)*sin_sfdm(pba,0.5*theta_sfdm_3)/y1_sfdm_3);
        /*delta_0*/
        dy[pv->index_pt_delta_sfdm_3] = -a_prime_over_a*((3.*sin_sfdm(pba,theta_sfdm_3)+omega_sfdm_3*(1.-cos_sfdm(pba,theta_sfdm_3)))*delta1_sfdm_3
                                                         -omega_sfdm_3*sin_sfdm(pba,theta_sfdm_3)*delta_sfdm_3)
        -metric_continuity*(1.-cos_sfdm(pba,theta_sfdm_3)); //metric_continuity = h'/2;
        /*delta_1*/
        dy[pv->index_pt_delta1_sfdm_3] = -a_prime_over_a*((3.*cos_sfdm(pba,theta_sfdm_3)+(omega_sfdm_3-0.5*pba->sfdm_parameters_3[1]*exp(alpha_sfdm_3)/y1_sfdm_3)*sin_sfdm(pba,theta_sfdm_3))*delta1_sfdm_3
                                                          -((omega_sfdm_3-0.5*pba->sfdm_parameters_3[1]*exp(alpha_sfdm_3)/y1_sfdm_3)*(1.+cos_sfdm(pba,theta_sfdm_3))*delta_sfdm_3))
        -metric_continuity*sin_sfdm(pba,theta_sfdm_3);
      }
      if(pba->sfdm_parameters_3[1] < 0.){
        dy[pv->index_pt_omega_sfdm_3] = a_prime_over_a*omega_sfdm_3*(1.5*pvecback[pba->index_bg_w_tot_3] - 0.5 - 0.5*pba->sfdm_parameters_3[1]*
                                                                     exp(alpha_sfdm_3-y1_sfdm_3)*sin_sfdm(pba, theta_sfdm_3)/pow(1.-pba->sfdm_parameters_3[1]*
                                                                                                                                 exp(alpha_sfdm_3-2.*y1_sfdm_3)*(1.+cos_sfdm(pba, theta_sfdm_3)),0.5));
        /*delta_0*/
        dy[pv->index_pt_delta_sfdm_3] = -a_prime_over_a*((3.*sin_sfdm(pba,theta_sfdm_3)+omega_sfdm_3*(1.-cos_sfdm(pba,theta_sfdm_3)))*delta1_sfdm_3
                                                         -omega_sfdm_3*sin_sfdm(pba,theta_sfdm_3)*delta_sfdm_3)
        -metric_continuity*(1.-cos_sfdm(pba,theta_sfdm_3)); //metric_continuity = h'/2;
        /*delta_1*/
        dy[pv->index_pt_delta1_sfdm_3] = -a_prime_over_a*((3.*cos_sfdm(pba,theta_sfdm_3)+(omega_sfdm_3-0.5*pba->sfdm_parameters_3[1]*exp(alpha_sfdm_3-y1_sfdm_3)/
                                                                                          pow(1.-pba->sfdm_parameters_3[1]*exp(alpha_sfdm_3-2.*y1_sfdm_3)*(1.+cos_sfdm(pba,theta_sfdm_3)),0.5))*
                                                           sin_sfdm(pba,theta_sfdm_3))*delta1_sfdm_3
                                                          -(omega_sfdm_3-0.5*pba->sfdm_parameters_3[1]*exp(alpha_sfdm_3-y1_sfdm_3)/
                                                            pow(1.-pba->sfdm_parameters_3[1]*exp(alpha_sfdm_3-2.*y1_sfdm_3)*(1.+cos_sfdm(pba, theta_sfdm_3)),0.5))*
                                                          (1.+cos_sfdm(pba,theta_sfdm_3))*delta_sfdm_3)
        -metric_continuity*sin_sfdm(pba,theta_sfdm_3);
      }
